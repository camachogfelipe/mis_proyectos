 ...
 * @version 	1.5.0
 */
function assets_css($assets = null, $attributes = null, $module = null, $is_modular = true) {
    Assets::css($assets, $attributes, $module, $is_modular);
}
...
function assets_js($assets = null,  $module = null, $is_modular = true) {
    Assets::js($assets, $module, $is_modular);
}
