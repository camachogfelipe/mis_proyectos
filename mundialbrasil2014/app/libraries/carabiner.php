...
class Carabiner {
     ...
     * @return   Void
     */
    public function css($dev_file, $media = '', $prod_file = '', $combine = TRUE, $minify = TRUE, $group = 'main') {
    ...
    private function _tag($flag, $ref, $cache = FALSE, $media = 'screen') {
        ...
        switch ($flag) {
            ...
            case 'css':
                ...
                return '<link rel="stylesheet" href="' . $dir . $ref . '" />';
            ...
            case 'js':
                ...
                return '<script src="' . $dir . $ref . '"></script>';
