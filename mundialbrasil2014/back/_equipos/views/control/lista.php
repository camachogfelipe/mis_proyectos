          ...
          <table id="dt_basic" class="dataTables_full table table-striped">
            ...
            <tbody id='table_contet'  >
              ...
              <tr class="odd gradeX parent-delete">
                ...
                <td class="nolink"><?php echo $img->nombre ?></td>
                <td class="nolink"><img style="height:48px;width:48px" src="<?php echo base_url() . $img->imagen_path ?>" /></td>
                <td class="nolink"><?php echo $img->grupo_nombre ?></td>
