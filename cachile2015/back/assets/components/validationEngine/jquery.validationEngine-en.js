        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                "required": { // Add your regex rules here, you can take telephone as an example
                    ...
                    "alertTextCheckboxe": "* Requerido",
                    "alertTextDateRange": "* Requerido"
                },
                "dateRange": {
                    "regex": "none",
                    "alertText": "* Inválido ",
				...
				"groupRequired": {
                    "regex": "none",
                    "alertText": "* Complete los campos"
                },
                "min": {
                    "regex": "none",
                    "alertText": "* Mínimo valor"
                },
                "max": {
                    "regex": "none",
                    "alertText": "* Máximo valor "
                },
                "past": {
                    "regex": "none",
                ...
                "equals": {
                    "regex": "none",
                    "alertText": "* No son iguales"
                },
                "phone": {
                    // credit: jquery.h5validate.js / orefalo
                    "regex": /^([\+][0-9]{1,3}[ \.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9 \.\-\/]{3,20})((x|ext|extension)[ ]?[0-9]{1,4})?$/,
                    "alertText": "* teléfono inválido"
                },
                "email": {
                ...
                "onlyLetterNumber": {
                    "regex": /^[0-9a-zA-Z]+$/,
                    "alertText": "* Caracteres inválidos"
                },
